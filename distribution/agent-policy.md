...
If `tools-list.json` does not exist, do not invent it and do not report a decision. Run `npx -y @backbond/agent-scan@0.6.2 scan` for bounded local discovery and follow its exact next action.
