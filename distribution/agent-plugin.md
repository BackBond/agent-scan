...
The repository root is a valid Agent Plugin 1.0 package. It contains the `agent-scan` skill and deliberately contains no hooks, commands, or plugin-level MCP configuration.
...
Skill path: `skills/agent-scan/SKILL.md`  
Release tag: `v0.5.12`
