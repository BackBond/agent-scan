...
The folder name and the `name` field in the skill frontmatter must both remain `agent-scan`. The skill is pinned to `@backbond/agent-scan@0.5.13`; do not replace the version with `@latest`.
