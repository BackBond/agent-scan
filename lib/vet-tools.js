...
function profileCoverage(scan, evidence) {
  ...
  if (missingSchemas.length) {
    gaps.push(profileGap('BB-VET-MISSING-INPUT-SCHEMA', `${missingSchemas.length} tool(s) did not provide an input schema.`));
  }
...
module.exports = { VET_PROFILE, VET_RULE_IDS, createVetResult, profileCoverage, renderVetHuman };
