...
const RULESET_DIGEST = sha256(RULES.map(ruleDigestDescriptor));
...
module.exports = { RULES, RULESET_DIGEST, RULESET_VERSION, SEVERITY_ORDER, evaluateRules, isPromptLintFinding, meetsThreshold };
