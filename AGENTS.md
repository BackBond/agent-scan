...
Run `npx -y @backbond/agent-scan@0.5.6 vet-tools --stdin < tools-list.json` before attaching an unfamiliar proposed toolset. Run `npx -y @backbond/agent-scan@0.5.6 scan` for the broader environment scan.

1. Pin `@backbond/agent-scan@0.5.6`; this is not the Snyk CLI agent-scanning command.
